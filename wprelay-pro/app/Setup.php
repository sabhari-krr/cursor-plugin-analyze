...
namespace RelayWp\Affiliate\App;
...
class Setup
{
    ...
    {
        register_activation_hook(RWPA_PLUGIN_FILE, [__CLASS__, 'activate']);
        register_deactivation_hook(RWPA_PLUGIN_FILE, [__CLASS__, 'deactivate']);
        register_uninstall_hook(RWPA_PLUGIN_FILE, [__CLASS__, 'uninstall']);
