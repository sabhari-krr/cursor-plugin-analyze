...
class AffiliateNewSaleMadeEmail extends WC_Email
{
    public function __construct()
    {
        ...
        $this->description = __('An email sent to the Affiliate', 'relay-affiliate-marketing');
        // For admin area to let the user know we are sending this email to customers.
        $this->heading = __('Affiliate Sale Made Email', 'relay-affiliate-marketing');
        // translators: placeholder is {blogname}, a variable that will be substituted when email is sent out
        $this->subject = __("[{site_title}] Congratulations- You Just Made an Affiliate Sale!", 'relay-affiliate-marketing');

        $this->customer_email = false;

        $this->template_html = 'affiliate-new-sale-made.php';

        $this->template_plain = 'plain/affiliate-new-sale-made.php';
        parent::__construct();
