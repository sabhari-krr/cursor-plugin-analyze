...
class AffiliateRegisterRequest implements FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            /* translators: placeholder description */
            'country.required' => vsprintf(esc_html__('%s is required', 'relay-affiliate-marketing'), [__('Country', 'relay-affiliate-marketing')]),
            /* translators: placeholder description */
