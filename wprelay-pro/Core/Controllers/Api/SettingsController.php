...
namespace RelayWp\Affiliate\Core\Controllers\Api;
...
class SettingsController
{
    ...
    public function saveAffiliateSettings(Request $request)
    {
        ...
        try {
            ...
            $existing_affiliate_settings['url_options']['referral_code_value'] = $request->get('url_options.referral_code_value');
    ...
    public static function saveEmailSettings(Request $request)
    {
        ...
        try {
            ...
            $existing_email_settings['affiliate_emails']['affiliate_new_sale_made'] = Functions::getBoolValue($request->get('affiliate_emails.affiliate_new_sale_made'));
