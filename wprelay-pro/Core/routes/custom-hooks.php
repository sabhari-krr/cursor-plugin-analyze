...
$admin_hooks = [
    'actions' => [
        ...
        'rwpa_send_new_sale_made_affiliate_email' => ['callable' => [EmailController::class, 'sendAffiliateNewSaleMadeEmail'], 'priority' => 10, 'accepted_args' => 2],
        ...
        'rwpa_payment_reverted' => ['callable' => [CouponPayout::class, 'removeCouponUsage'], 'priority' => 11, 'accepted_args' => 1],
    ],
    'filters' => [
